...
@testset "my tests" begin
    @testset "R/W CircularBuffer of size 1" begin
    ...
    @testset "R/W CircularBuffer of size 3" begin
    ...
    @testset "first & last" begin
        ...
        popfirst!(cb)
        @test first(cb) == last(cb) == 3

        cb = CircularBuffer{Int}(3)
        for x in 1:4
            push!(cb, x, overwrite=true)
        end
        # [4][2][3]
        @test first(cb) == 2
        @test last(cb) == 4
